<template>
    ...
    <x-header class="x-header" :left-options="{backText: ''}">                        <a slot="overwrite-left">
      ...
      </a><p class="title">共产党员标兵</p></x-header>
    <div><img class="pic1" src="../assets/party1.jpg"></div>
    <div class="border">
      <div class="flex">
        <img class="tubiao1" src="../assets/dangz.png">
        <div class="word">产党员标兵评选标准</div>
      </div>
      <div class="line"></div>
    </div>
    <div class="border">
