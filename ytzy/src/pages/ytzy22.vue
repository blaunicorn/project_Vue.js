<template>
  <div class="body">
    <x-header class="x-header" :left-options="{backText: ''}">                        <a slot="overwrite-left">
      ...
      </a><p class="title">优秀基层党组织评选</p></x-header>
    <div><img class="pic1" src="../assets/party3.jpg"></div>
    <div class="border">
      <div class="flex">
        <img class="tubiao1" src="../assets/model3.png">
        <div class="word">优秀基层党组织评选标准</div>
      </div>
      <div class="line"></div>
    </div>
    <div class="border">
...
<style scoped>
  ...
  .line{
    border-bottom: solid 6px #F7BEC2;
    width: 100%;
  }
</style>
